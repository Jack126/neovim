...
vim.keymap.set("n", "<space>q", vim.diagnostic.setloclist, opts,{desc="List Error"})
...
local on_attach = function(client, bufnr)
    ...
    vim.keymap.set("n", "gd", vim.lsp.buf.definition, bufopts,{desc="Go to definition"}) -- gd goes to definition, C-o can go back
